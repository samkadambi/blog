...
function App() {
  return (
            ...
            {close => (
              <div className="modal">
                ...
                <div className="content">
                  ...
                  take a look for yourself. We went there by bus, which 
                  took about 4 hours. Even so, we stopped at the 2 hour mark to get food and drinks which instantly had me thinking about how the French
                  really don't road trip much. A 4 hour drive back home is usually done without any stops. But why would the French need to travel anyway?
                  Especially if you live within the vicinity of Paris, there is always something to do. It's a complete 180 from Michigan where people 
                  literally walk down the aisles of grocery stores as their concept of "fun."
                  Anyways, to describe my time in Brussels in one word, I'd go with "boolery." We got there around 11ish at night which is around the time
                  that the energy of the city started to pick up. We were living in a hostel not too far with a beautiful view of the river Senne just a couple 
                  ...
                  beautiful sentence in Franglais that I could have ever crafted: "Bonsoir monsieur, je voudrais le AK-47, s'il vous plait." The confused looks I got
                  ...
                  around. Pretty much everyone within a 100m radius had their eyes glued on this rather unconventional tradition, cheering loudly with some even joining in. The next hour or so consisted of the French students initiating the 
                  ...
                  with me on the way back. Not once did it occur to me that I may be out of place or different. This weekend, I was a European at heart. Pretty much everyone's essay for their study abroad application must have
                  incorporated the idea of "exploring a new culture or language." The truth is, that won't just naturally happen just because you're in the vicinity of people who are of that different culture.
                  Making a conscious effort to be open-minded and see things from a different perspective is what really elevated this weekend in my mind. I will definitely be back at some point to visit the more scenic parts of Belgium,
                  most notably Brugge. Until then, this is Maanas, signing off.
                </div>
        ...
        icon={<WbSunnyIcon/>}
        >
          <h1> Maanas munches on pizza in Italy</h1>
          <Popup trigger={<Button variant="contained" className="button"> click for a milli </Button>} 
          modal
          nested
          >
